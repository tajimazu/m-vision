...
menu_data = {
    "彩りヘルシー（鮭・ブロッコリー）": {
        "name": "特選！わっぱの彩り鮭弁当",
        "img": "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=800", # 鮭・卵・緑の入った鮮やかなお弁当イメージ
        "text": "🔴 赤：焼き鮭のほぐし身\n🟢 緑：ブロッコリーのごま和え\n🟡 黄：ふっくら卵焼き",
        "tip": "丸・楕円形のお弁当箱は、ご飯を斜めに敷き詰めて、その境界線に沿って「卵焼き」や「ブロッコリー」をカーブさせて並べると、隙間が一切なくなりプロ並みの美しさになります！"
    },
    "ガッツリ肉系！": {
        "name": "四角お弁当のための「鶏のから揚げ弁当」",
